    ...
    <div>
        <div style={{ backgroundImage: `url(${assets.background2})` }} className={`min-h-[100vh]  bg-cover bg-center px-4`}> 
            ...
            <div className='flex flex-col sm:flex-row gap-5 justify-center items-center'>
                    <MiniCard2 title={"Our Mission"} text={"Shuttlr is a testament to the innovative spirit of Luther College, brought to life by Daniel Yormesor (Class of '26) and Mahadi Hossain Aryan (Class of '28). We're not just providing a shuttle service; we're building a solution to a real need within our student community and the broader Decorah area."}/>
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
                <MiniCard3 img={assets.daniel} name={"Daniel Yormesor"} text={"Founder of Shuttlr | Luther College Class of '26"} />
