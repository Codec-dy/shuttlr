...
const Home = () => {
  return (
    <div className=''>
      <div style={{ backgroundImage: `url(${assets.background1})` }} className={`min-h-[100vh]  bg-cover bg-center`}> 
        <div className='flex flex-col justify-center items-center gap-2 text-center'>
          ...
          <div className='flex flex-col border rounded-sm p-4 gap-4 items-center w-full max-w-[400px]'>
